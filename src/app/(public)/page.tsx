...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="como-funciona" className="py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mt-2 mb-4">Como funciona</h2>
          ...
          <div className="space-y-4">
            {STEPS.map((step, index) => (
              ...
              >
                <div className="flex-shrink-0 w-12 h-12 bg-blue-700 text-white rounded-xl flex items-center justify-center font-bold text-lg">
                  {step.number}
                </div>
                <div>
                ...
                {index < STEPS.length - 1 && (
                  <div className="hidden md:block ml-auto text-slate-300">
      ...
      {/* PACOTES */}
      <section id="pacotes" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-blue-700 font-semibold text-sm uppercase tracking-wider">Planos e preços</span>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mt-2 mb-4">Escolha seu pacote</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
      ...
      <section id="depoimentos" className="py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mt-2 mb-4">O que dizem nossos clientes</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t) => (
              <div key={t.name} className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
      ...
      <section id="faq" className="py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mt-2 mb-4">Perguntas frequentes</h2>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-6 text-sm">
              ...
              <a href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '5511999999999'}`} className="hover:text-white transition-colors">WhatsApp</a>
            </div>
            <p className="text-sm">© 2024 Cia do Visto. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
