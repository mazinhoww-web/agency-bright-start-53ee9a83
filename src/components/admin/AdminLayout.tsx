...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex">
      {/* Admin Sidebar */}
      <aside className="w-64 bg-slate-900 text-white flex-col fixed h-full z-10 hidden md:flex">
        <div className="p-6 border-b border-slate-700">
          ...
          <span className="text-xs text-slate-400 font-medium bg-slate-700 px-2 py-0.5 rounded-full">Admin</span>
        </div>
